...
public class ViewGameListTest {
    ...
    public void ViewGameListTC1() {
        ...
        try {
            ...
            assertTrue("true input", e.getMessage().toString().equalsIgnoreCase("input is not one in options!"));
        }
    }
    ...
    public void ViewGameListTC10() {
        ...
        try {
            ...
            assertTrue(e.getMessage().toString().equalsIgnoreCase("input is back to previousPage!"));
        }
    }
    ...
    public void ViewGameListTC12() {
        ...
        try {
            ...
            assertTrue("true input", e.getMessage().toString().equalsIgnoreCase("Game index not found!"));
        }
    }
    ...
    public void ViewGameListTC14() {
        ...
        try {
            ...
            assertTrue("is not game index", e.getMessage().toString().equalsIgnoreCase("input is game index"));
        }
    }
}